export const en = {
    ...
    settingsCustomSearchPipeline: 'Visualize individual queries as connected pipelines',
    settingsCustomSearchPipelineDesc: 'Enable the experimental pipeline view for custom queries.',
